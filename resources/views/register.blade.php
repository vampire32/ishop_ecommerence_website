...
<img src="https://jasper-pimstorage-skullcandy.s3.us-west-1.amazonaws.com/bd2253a9671dac36a95faf821b52e78935050140be1718ce001f6aace45cf25c.png" class="h-96 absolute right-5 mr-5">
      ...
      <div class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white ">
        <div class="max-w-md w-full space-y-8">
          ...
          <form class="mt-8 space-y-6" action="/regsiter" method="POST">
            @csrf
            <input type="hidden" name="remember" value="true">
            <div class="relative">

              <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">Full Name</label>
              <input class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="text" name="name" >
              @error('name')
              <p class="tex-sm text-red-600 font-bold">{{$message}}</p>
            ...
            <div class="relative">
              ...
              <input class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="email" name="email">
              @error('email')
              <p class="tex-sm text-red-600 font-bold">{{$message}}</p>
            ...
            <div class="mt-8 content-center">
              ...
              <input class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500" type="password" name="password">
              @error('password')
              <p class="tex-sm text-red-600 font-bold">{{$message}}</p>
           ...
           <div class="relative">
              ...
              <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">Address</label>
              <input class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="text" name="Address" >
              @error('Address')
              <p class="tex-sm text-red-600 font-bold">{{$message}}</p>
            ...
            <div class="relative">
              ...
              <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">Phone Number</label>
              <input class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="text" name="Number">
              @error('Number')
              <p class="tex-sm text-red-600 font-bold">{{$message}}</p>
